...
public class NoteDatabase extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME ="notedbss";
    private static final String DATABASE_TABLE = "notestabless";
    ...
    public void onCreate(SQLiteDatabase db) {
        // CREATE TABLE tablename(id INT PRIMARY KEY, title TEXT, content TEXT, photo TEXT, date TEXT, time TEXT  );
